...
const ChatPage = () => {
	...
	const { messages, getMessages, subscribeToMessages, unsubscribeToMessages } = useMessageStore();
	...
	}, [getMyMatches, authUser, getMessages, subscribeToMessages, unsubscribeToMessages, id]);
