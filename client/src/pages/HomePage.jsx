...
const HomePage = () => {
  const {userProfiles, isLoadingUserProfiles, getUserProfiles, subscribeToNewMatch, unsubscribeToNewMatch} = useMatchStore();
  ...
  }, [authUser, unsubscribeToNewMatch, subscribeToNewMatch])
